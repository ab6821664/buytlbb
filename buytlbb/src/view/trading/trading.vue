        ...
        <div class="main-content">
            ...
            <div class="main-table">
                <div style="display: flex;justify-content: space-between;margin-top: 30px">
                    <div class="search-filter">
                        <div>
                            <span class="link-to" @click=" chooseZero=true;" style="top:-15px"> 选择游戏区服 ? {{chooseServerSelectIt.name}}</span>
                        </div>
                    </div>
                    <div>
            ...
            <div class="main-table">
                <el-table  :data="mainData"   border  style="width: 100%;font-size:12px" height="650" >
                    <el-table-column      prop="name"   label="主要信息"   width="200">    </el-table-column>
                    <el-table-column     sortable    prop="price"   label="原先价格"   width="80">    </el-table-column>
                    <el-table-column     sortable    prop="price_new"   label="最新价格"   width="80">    </el-table-column>
                    <el-table-column     sortable    prop="drop"   label="降价%比"   width="80">    </el-table-column>
...
<script>
    ...
    import {monitorPrice} from '../../api/nodeApi'
    export default {
        data:function(){
            return {
                chooseServerSelectIt:{name:'全部区服',id:1},
                chooseZero:false,
                serverFilter:'',
                allChildServe:[],
                mainData:[],
        ...
        methods:{
            ...
            mainQuery(params){
                monitorPrice(params).then((res)=>{
                       this.mainData = res;
                       this.mainData.forEach((item)=>{
                           if(item.price_new - item.price>0){
                               item.drop = 0;
                           }else{
                               item.drop = parseInt((item.price - item.price_new)/item.price*100)
                           }
                           return item;
                       })
                })
